...
%square grid of 201x201 nodes, with spacing h=0.1 mm and a velocity given 
%by Matlab's "peaks" function, with a source located at random. 
%
...
show_movie_2d_xy(x,y,Vh,T, 0.01)