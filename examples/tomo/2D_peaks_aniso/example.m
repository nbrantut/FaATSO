...
%
%This is a basic test of the tomographic method, using a 2d anisotropic
...
%
%The prior model is initially homogeneous anisotropic, and the prior event
...
%
% 1. maybe modify the path to the "synthetic" binary if needed.
...
% prior homogeneous V and E value
V0 = 3;
E0 = 0;
...
% path to the exacutable to ru the synthetic data
...
[Vh, E, h, sensors, events] = truemodel_2d_xz(Nev);

% compute synthetic data with noise:
run_synthetic(events, sensors, Vh, E, h, noise_t, synth_path, folder)

% compute prior model
[Vh_prior, E_prior, events_prior] = priormodel_2d_xz(V0, E0, Vh, events, noise_p);
